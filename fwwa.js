 ...
 */
 function doGet(e) {
    var Get = e.parameter;
    if (Get.url.includes("linkedin")) var DB = SpreadsheetApp.openById(/** SHEET-ID */).getSheetByName("DB");
    else var DB = SpreadsheetApp.openById(/** SHEET-ID */).getSheetByName("FreelanceDB");
